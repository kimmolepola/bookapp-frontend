...
const headCells = [
  ...
  {
    id: 'born', numeric: true, disablePadding: false, label: 'Birth year',
  },
  {
    id: 'bookCount', numeric: true, disablePadding: false, label: 'Books',
  },
];
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.bookCount}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
